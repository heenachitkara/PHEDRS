...
jQuery(window).trigger(jQuery.phedrs.app.events.builder_loaded, (function ($_, app_) {
    ...
    // The "Patient attributes" dialog builder
    return new function () {

        var self = this;

        this.dialogSelector = "#patientAttribute_config_dialog";
        ...
        this.key = "patientAttribute_config_dialog";
        ...
        this.initialize = function () {
            ...
            $_(".patientAttrib-save-button").click(function () {               
                self.saveAttribute();
            });

            $_(".patientAttrib-cancel-button").click(function () {
        ...
        this.saveAttribute = function () {
            ...
            var regName = document.getElementById("configPatient_attributes_add_registry_name").value; //$_("configPatient_attributes_add_registry_name").val();
            var regDef = document.getElementById("configPatient_attributes_add_registry_def").value; //$_("configPatient_attributes_add_registry_def").val();
            ...
            console.log(data);
            app_.getNoPreValidateConfigReg(data, self.cancelExternalDialog, app_.processError, self.urlKeys.add_PatientAttribute_CVTerm);
        };
    };
