...
jQuery(window).trigger(jQuery.phedrs.app.events.builder_loaded, (function ($_, app_) {
    ...
    // The "registry status history" dialog builder
    return new function () {

        var self = this;

        this.dialogSelector = "#registry_status_history_dialog";

        // This object's key in the Application.components collection.
        this.key = "registry_status_history_dialog";
        ...
        // The web service key.
        this.urlKey = "getregistrystatushistory";
        ...
        this.initialize = function () {
        	...
        	$_("#registry_status_person").html(self.patient.name);
        	$_("#registry_status_mrn").html("MRN: " + self.patient.mrn);
        ...
        this.processHistoryDetails = function (data_, textStatus_, jqXHR_) {
            ...
            /*console.log("I am inside Index for Moment Test for Reg status History Dialog");

            console.log(data_.statuses[0].changeDate);

            var dateMoment = data_.statuses[0].changeDate;

            console.log(moment(dateMoment).format('MM/DD/YYYY'));*/

            //console.log(moment(assignmentDate).format('MM/DD/YYYY'));
            ...
            $_("#registryHistoryDetailsPanel").jqxGrid({
                source: dataAdapter,
                width: 750,
                height: 150,
